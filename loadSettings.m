...
if currentYear == initYear % source file
   settings.SourceFilename       = 'F:\ParticleTrajectoryModel\utils\source function\UniformSource.nc';
else % hot start
   settings.SourceFilename       = ['F:\particles\try\UniformSource_lowstokes_1pWindage_' num2str(currentYear-1) '.nc'];
end

%% Output File
settings.OutputFilename       = ['F:\particles\try\UniformSource_lowstokes_1pWindage_' num2str(currentYear) '.nc'];
