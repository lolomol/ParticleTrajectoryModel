...
for year=1992:2007
    for month=1:12
        try
            ...
            hfile=['C:\Users\lolo\Documents\TheOceanCleanup\wavewatch3\CFSR\multi_reanal.glo_30m.hs.' sprintf('%d',year) sprintf('%02d',month)  '.grb2.gz'];
            pfile=['C:\Users\lolo\Documents\TheOceanCleanup\wavewatch3\CFSR\multi_reanal.glo_30m.tp.' sprintf('%d',year) sprintf('%02d',month)  '.grb2.gz'];
            dfile=['C:\Users\lolo\Documents\TheOceanCleanup\wavewatch3\CFSR\multi_reanal.glo_30m.dp.' sprintf('%d',year) sprintf('%02d',month)  '.grb2.gz'];
            ...
            hNCfile=['E:/wavewatch3/CFSR/hs_' num2str(year) '_' num2str(month) '.nc'];
            pNCfile=['E:/wavewatch3/CFSR/tp_' num2str(year) '_' num2str(month) '.nc'];
            dNCfile=['E:/wavewatch3/CFSR/dp_' num2str(year) '_' num2str(month) '.nc'];
            ...
            netcdf.putAtt(ncid,3,'scalingFactor','0.01')
            netcdf.endDef(ncid)
